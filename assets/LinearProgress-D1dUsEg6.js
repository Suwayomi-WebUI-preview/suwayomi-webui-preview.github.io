import{Ds as e,Gs as t,Jc as n,Os as r,Qs as i,Ss as a,Ws as o,Yc as s,Zc as c,Zo as l,dc as u,ec as d,fc as f,gc as p,hc as m,uc as h,xs as g}from"./index-BJLKxFwC.js";var _=c(n(),1);function v(e){return u(`MuiLinearProgress`,e)}h(`MuiLinearProgress`,[`root`,`colorPrimary`,`colorSecondary`,`determinate`,`indeterminate`,`buffer`,`query`,`dashed`,`bar`,`bar1`,`bar2`]);var y=s(),b=4,x={},S=p`
  0% {
    left: -35%;
    right: 100%;
  }
